...
<main class="card">
    ...
    <p class="muted"><?= e($message ?? 'Something went wrong while processing your request. Please try again shortly.') ?></p>
    <?php if (!empty($reference)): ?><p class="ref">Reference <code><?= e((string)$reference) ?></code></p><?php endif; ?>
    <div class="actions"><a href="/">Return home</a><a class="secondary" href="javascript:location.reload()">Try again</a></div>
</main>
</body>
</html>
