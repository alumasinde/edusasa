...
<main class="card">
    ...
    <div class="icon">!</div>
    <h1>Access denied</h1>
    <p class="muted"><?= e($message ?? 'You do not have permission to access this page.') ?></p>
    <?php if (!empty($reference)): ?><p class="ref">Reference <code><?= e((string)$reference) ?></code></p><?php endif; ?>
    <div class="actions"><a href="/">Return home</a><a class="secondary" href="javascript:history.back()">Go back</a></div>
</main>
</body>
</html>
