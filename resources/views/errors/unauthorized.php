...
<main class="card">
    ...
    <p class="muted"><?= e($message ?? 'Please sign in to continue.') ?></p>
    <div class="actions"><a href="/login">Sign in</a></div>
</main>
</body>
</html>
