...
final class FinanceController extends BaseController
{
    ...
    public function createPayment(Request $request): Response { return $this->view('finance.payment_create',['students'=>$this->finance->students((string)$request->input('student_search','')),'today'=>date('Y-m-d')]); }
