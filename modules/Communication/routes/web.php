...
$router->group(['prefix'=>'/communication','middleware'=>['tenant','auth','module:communication']],function($router){
 ...
 $router->get('/{id}',[CommunicationController::class,'show'],['permission:communication.view']);
