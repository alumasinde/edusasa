...
--
-- This migration was moved from 026_stabilization.sql so migration numbers
-- remain unique. Every ALTER is idempotent because deployments may have
-- partially applied the earlier stabilization migration.
